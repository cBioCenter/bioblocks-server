...
import { AMINO_ACID_1LETTER_CODE, Bioblocks1DSection, BioblocksPDB, CouplingContainer, ISpringGraphData } from './';
...
export declare type BIOBLOCKS_DATA_TYPE = CONTACT_MAP_DATA_TYPE | NGL_DATA_TYPE | SPRING_DATA_TYPE | T_SNE_DATA_TYPE;
...
export declare enum COUPLING_SCORE_SOURCE {
    'cn' = "cn",
    'dist' = "dist",
...
export interface ICouplingScore {
    A_i?: AMINO_ACID_1LETTER_CODE;
    A_j?: AMINO_ACID_1LETTER_CODE;
    cn?: number;
    dist?: number;
    dist_intra?: number;
...
export declare enum CONTACT_DISTANCE_PROXIMITY {
...
export declare type SECONDARY_STRUCTURE_SECTION = Bioblocks1DSection<SECONDARY_STRUCTURE_KEYS>;
export declare type SECONDARY_STRUCTURE = Array<Bioblocks1DSection<SECONDARY_STRUCTURE_KEYS>>;
export interface IResiduePair {
    i: number;
    j: number;
}
export declare enum SECONDARY_STRUCTURE_CODES {
    'G' = "310_HELIX",
    'H' = "ALPHA_HELIX",
    'I' = "PI_HELIX",
...
export declare type SECONDARY_STRUCTURE_KEYS = keyof typeof SECONDARY_STRUCTURE_CODES;
export declare enum BIOBLOCKS_CHART_EVENT_TYPE {
    AFTER_PLOT = 0,
    CLICK = 1,
    DOUBLE_CLICK = 2,
    HOVER = 3,
